...
plotSlopes(m1, plotx = "education", modx = "type")
dev.new()
plotSlopes(m1, plotx = "education", modx = "type", modxVals = c("prof"))
dev.new()
plotSlopes(m1, plotx = "education", modx = "type", modxVals = c("bc"))
dev.new()
plotSlopes(m1, plotx = "education", modx = "type", modxVals = c("bc", "wc"))
