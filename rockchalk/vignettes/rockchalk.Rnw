\batchmode
\makeatletter
\def\input@path{{/home/pauljohn/GIT/rockchalk/package/rockchalk/vignettes//}}
\makeatother
...
\bibliography{0_home_pauljohn_GIT_rockchalk_package_rockchalk_vignettes_rockchalk}
