...
At one point, the only guide was the Google R style guide,\footnote{\url{http://google-styleguide.googlecode.com/svn/trunk/google-r-style.html}}
...
Style Guide.\footnote{\url{https://github.com/hadley/devtools/wiki/Style}}
...
GNU coding standards.\footnote{\url{http://www.gnu.org/prep/standards/standard.html}}
